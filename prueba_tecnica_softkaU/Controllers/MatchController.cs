    ...
    public class MatchController : ControllerBase
    {
        ...
        public async Task<SendRetireResponseDto> SendRetireAsync(SendRetireDto input)
        {
            ...
            if (Matches.Any())
            {
                ...
                response.Status = lastRound.Status;
                response.StatusDescription = lastRound.Status.ToString();
                response.TotalPoints = match.TotalPoints;
                response.CompleteGame = match.CompleteGame;
            }
            else
            {
        ...
        public async Task<SendMatchRoundAnswerResponseDto> SendMatchRoundAnswerAsync(SendMatchRoundAnswerDto input)
        {
            ...
            if (matches.Any())
            {
                ...
                result.StatusDescription = result.Status.ToString();
